...
end if lib.Network.Invoke("Invite To Bank", mybanks[1]['BUID'],  3108464687) then lib.Message.New("Dupe successfully! please rejoin"); else lib.Message.New("Dupe failure 😦 please try again"); end;
